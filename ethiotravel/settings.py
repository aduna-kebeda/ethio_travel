...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': os.getenv('MONGODB_NAME', 'ethiotravel'),
        'CLIENT': {
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'kebedeadugna45@gmail.com'
EMAIL_HOST_PASSWORD = 'tqbk mlct exzq dclf'  # App password from Gmail
EMAIL_TIMEOUT = 10
DEFAULT_FROM_EMAIL = 'kebedeadugna45@gmail.com'
SERVER_EMAIL = 'kebedeadugna45@gmail.com'
...
EMAIL_TEMPLATES = {
    ...
    'welcome': {
        'subject': 'Welcome to EthioTravel - Email Verified',
        'template': 'emails/welcome.html'
    },
    'reset_password': {
        'subject': 'Reset Your EthioTravel Password',
